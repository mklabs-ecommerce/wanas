...
_FACTS_NUDGE = (
    ...
    "أداة في المحادثة دي. كل سعر أو إجمالي أو قياس بالسنتيمتر أو عدد قطع باقية أو مدة "
    "لازم يتنقل حرفياً من نتيجة أداة أو من كلام المحل المنشور: get_variants للسعر والكمية، "
    "checkout من get_shipping_fee للإجمالي، get_size_chart للقياسات، ومدة التوصيل زي ما "
    "هي في تعليماتك. نادي الأداة دي في نفس الرد، أو اكتب ردك من غير الرقم. "
    "متحسبش أي رقم بنفسك."
)
