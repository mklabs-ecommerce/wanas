...
_HANDOFF_BANKS: dict[str, tuple[str, ...]] = {
    ...
    "product_info": (
        ...
        "ابعتلي في الدايركت وأقولك تفاصيل الخامة.",
...
_DM_OPENERS: dict[str, tuple[str, ...]] = {
    "price": (
        ...
        "وصلني كومنتك «{comment}». قولّي أنهي موديل ولون وأقولك بكام وأنهي مقاسات متاحة.",
    ...
    "availability": (
        ...
        "نورتنا. «{comment}» — قولّي القطعة وأشوفلك اللي لسه متاح منها.",
    ),
    "size": (
        "شفت كومنتك على البوست:\n«{comment}»\nقولّي طولك ووزنك وأرشحلك المقاس المظبوط.",
        "أهلاً بيك. بخصوص «{comment}» — عندي جدول المقاسات كامل، قولّي القطعة وأظبطهولك.",
    ...
    "variant": (
        ...
        "أهلاً بيك. بخصوص «{comment}» — عندنا أكتر من لون وموديل، قولّي اللي يناسبك وأرشحلك.",
    ...
    "product_info": (
        ...
        "أهلاً بيك. بخصوص «{comment}» — حدّدلي الموديل وأقولك الخامة والتفاصيل.",
    ...
    "complaint": (
        ...
        "آسفين على اللي حصل. «{comment}» — قولّي بياناتك وهنشوفها على طول.",
    ),
    "other": (
        "شفت كومنتك على البوست:\n«{comment}»\nقولّي محتاج إيه وأنا تحت أمرك.",
